...
function buildActionButtons(
  ...
  return '<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px;">'
    ...
    + '<a href="' + confirmUrl + '" style="display:block;padding:16px 12px;font-size:11px;color:#ffffff;letter-spacing:2px;text-transform:uppercase;font-family:\'Helvetica Neue\',Arial,sans-serif;font-weight:600;text-decoration:none;text-align:center;white-space:nowrap;">'
    ...
    + '<a href="' + reprogramareUrl + '" style="display:block;padding:13px 10px;font-size:10px;color:#555555;letter-spacing:2px;text-transform:uppercase;font-family:\'Helvetica Neue\',Arial,sans-serif;font-weight:500;text-decoration:none;text-align:center;white-space:nowrap;">'
    + '\u21ba &nbsp;Reprogrameaz\u0103'
    + '</a></td></tr></table></td>'
    ...
    + '<a href="' + anulareUrl + '" style="display:block;padding:13px 10px;font-size:10px;color:#BBBBBB;letter-spacing:2px;text-transform:uppercase;font-family:\'Helvetica Neue\',Arial,sans-serif;font-weight:500;text-decoration:none;text-align:center;white-space:nowrap;">'
    + '\u2715 &nbsp;Anuleaz\u0103'
    + '</a></td></tr></table></td>'
    + '</tr></table>'
}
